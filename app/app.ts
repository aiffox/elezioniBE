...
app.get('/votazione/:vUUID/liste', function(req:Request, res:Response) {
...
app.get('/votazioni', function(req:Request, res:Response) {
...
app.get('/votazione/:vUUID/settings', function(req:Request, res:Response) {
  ...
  try{
    ...
    client.connect().then((client:any)=>{
      ...
      db.collection("votazioni").findOne({"UUID":vUUID}).then((data:any)=>{
        console.log((data));
        if(data){
          console.log("success\n");
...
app.get('/votazione/:vUUID/liste/classifica', function(req:Request, res:Response) {
...
app.get('/votazione/:vUUID/liste/:UUID', function(req:Request, res:Response) {
  console.log("votazione/:vUUID/liste/:UUID : GET called");
  try{
    const UUID=req.params.UUID;
    const vUUID=req.params.vUUID;
    var list;

    client.connect().then((client:any)=>{
      var db = client.db(dbName);
      db.collection("liste").findOne({"UUID":UUID, "vUUID":vUUID}).then((data:any)=>{
        console.log((data));
        if(data){
          console.log("success\n");
          res.status(200).send(data);
...
app.post('/votazione/:vUUID/liste', function(req:Request, res:Response) {
...
app.post('/votazione', function(req:Request, res:Response) {
...
app.put('/votazione/:vUUID/liste/:UUID', function(req:Request, res:Response) {
  ...
  try{
    ...
    if((v.validate(doc, list_schema, {required: true}).valid)){
      client.connect().then((client:any)=>{
        var db = client.db(dbName);
        db.collection("liste").replaceOne({"UUID":UUID, "vUUID":vUUID},doc,{}).then((result:any)=>{
...
app.put('/votazione/:vUUID/settings', function(req:Request, res:Response) {
  ...
  try{
   ...
   /* console.log(doc);
    ...
    if((v.validate(doc, settings_schema, {required: true}).valid)){
      client.connect().then((client:any)=>{
        var db = client.db(dbName);
        db.collection("votazioni").replaceOne({"UUID":vUUID},doc,{ upsert: true }).then((result:any)=>{
          if(result.modifiedCount==1){
            res.status(200).send(doc);
            console.log("success\n");
          }
...
app.patch('/votazione/:vUUID/liste/:UUID/vote', function(req:Request, res:Response) {
  ...
  try{
    ...
    client.connect().then((client:any)=>{
      var db = client.db(dbName);
      db.collection("liste").updateOne(filters,query,options).then((result:any)=>{
        if(result.modifiedCount ==1){
          console.log("success\n");
          res.status(200).send();
        }
...
app.delete('/votazione/:vUUID/liste/:UUID', function(req:Request, res:Response) {
  ...
  try{
    ...
    client.connect().then((client:any)=>{
      var db = client.db(dbName);
      db.collection("liste").deleteOne({"UUID":UUID, "vUUID":vUUID}).then((result:any)=>{
        //console.log((result));
...
app.delete('/votazione/:vUUID', function(req:Request, res:Response) {
  ...
  try{
    ...
    client.connect().then((client:any)=>{
      var db = client.db(dbName);
      db.collection("votazioni").deleteOne({"UUID":vUUID}).then((result:any)=>{
        //console.log((result));
        if(result.deletedCount==1){
          console.log("success\n");
          res.status(200).send(result);
